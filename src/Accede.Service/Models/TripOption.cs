...
public record Flight(
    ...
    [Description("Scheduled departure time. Use ISO 8601 format.")] DateTime DepartureTime,
    [Description("Scheduled arrival time. Use ISO 8601 format.")] DateTime ArrivalTime,
...
public record Hotel(
    ...
    [Description("Date and time of check-in. Use ISO 8601 format.")] DateTime CheckIn,
    [Description("Date and time of check-out. Use ISO 8601 format.")] DateTime CheckOut,
...
public record CarRental(
    ...
    [Description("Date and time of vehicle pickup. Use ISO 8601 format.")] DateTime PickupTime,
    [Description("Date and time of vehicle return. Use ISO 8601 format.")] DateTime DropoffTime,
