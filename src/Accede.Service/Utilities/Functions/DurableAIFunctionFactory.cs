...
public static partial class DurableAIFunctionFactory
{
    /// <summary>Holds the default options instance used when creating function.</summary>
    private static readonly DurableAIFunctionFactoryOptions _defaultOptions = new();
    ...
    public static AIFunction Create(Delegate method, DurableAIFunctionFactoryOptions? options)
    {
    ...
    {
        public static ReflectionAIFunction Build(MethodInfo method, object? target, DurableAIFunctionFactoryOptions options)
        {
            ArgumentNullException.ThrowIfNull(method);
        ...
        private ReflectionAIFunction(ReflectionAIFunctionDescriptor functionDescriptor, object? target, DurableAIFunctionFactoryOptions options)
        {
            FunctionDescriptor = functionDescriptor;
            Target = target;
            _options = options;
            AdditionalProperties = options.AdditionalProperties ?? ReadOnlyDictionary<string, object?>.Empty;
        }


        public ReflectionAIFunctionDescriptor FunctionDescriptor { get; }
        public object? Target { get; }
        private readonly DurableAIFunctionFactoryOptions _options;
            ...
            CancellationToken cancellationToken)
        {
            ...
            var returnValue = await Task.Factory.StartNew(
                () => ReflectionInvoke(FunctionDescriptor.Method, Target, args),
                CancellationToken.None,
                TaskCreationOptions.DenyChildAttach,
                _options.TaskScheduler ?? TaskScheduler.Default).ConfigureAwait(false);
    ...
    private sealed class ReflectionAIFunctionDescriptor
    {
        ...
        /// </summary>
        public static ReflectionAIFunctionDescriptor GetOrCreate(MethodInfo method, DurableAIFunctionFactoryOptions options)
        {
