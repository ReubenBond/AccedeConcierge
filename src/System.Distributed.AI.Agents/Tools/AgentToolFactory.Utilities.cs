...
public static partial class AgentToolFactory
{
    ...
    internal static partial Regex InvalidNameCharsRegex();
#else
    internal static Regex InvalidNameCharsRegex() => _invalidNameCharsRegex;
    ...
    internal static object? ReflectionInvoke(MethodInfo method, object? target, object?[]? arguments)
    {
#if NET
