...
/// </summary>
public sealed class DurableAIFunctionFactoryOptions
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DurableAIFunctionFactoryOptions"/> class.
    /// </summary>
    public DurableAIFunctionFactoryOptions()
    {
    }
